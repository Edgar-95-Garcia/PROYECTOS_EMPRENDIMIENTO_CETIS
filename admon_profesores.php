...
if (isset($_SESSION["admin_cetis"]) == null) {
    ...
    $datos_profesores = $obj_profesores->selectUsersProfesor();
    ?>
    <center>
        <br><br>
            ...
            <tbody>
                ...
                if (!empty($datos_profesores)) {
                    foreach ($datos_profesores as $profesor) {
                        ...
                        $correo = $k->dec(isset($profesor['CORREO']) ? $profesor['CORREO'] : '');
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info" style="width: 100px;" data-toggle="modal" data-target="#modal_modificar_usuario"
