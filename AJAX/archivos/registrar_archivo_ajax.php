...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    return $obj_proyectos->registro_archivo(array(null, $id_proyecto, $k->enc($nombre_archivo), $k->enc($file_type), $k->enc($file_size), $archivo, $k->enc($bloque) ,$k->enc(date("Y-m-d H:i:s"))));
